...
export class CcvaGraphsPublicComponent implements OnInit {
  @Input() graphData: any;
  ...
  created_at: string = '';
  task_id: string = '';
  ccva_graph_db_source: boolean = false;
  ...
  ngOnInit() {
    ...
    //         // this.graphData = progressData.data;
            this.task_id = this.graphData.task_id;

            // if (progressData.data[0]) {
              this.total_records =this.graphData.total_records;
              this.elapsed_time = this.graphData.elapsed_time;
              this.created_at = this.graphData.created_at;
            // }
            this.tempoChartData = this.graphData;
